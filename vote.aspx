<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vote.aspx.cs" Inherits="index" %>
                ...
                <table id="main">
                    ...
                    <tr>
                        <td style="width: 550px">
                            <div id="0" style="background-color: #acd6ff; width: 50px; height: 20px; border-width: 0px;">
                            </div>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <div id="1" style="background-color: #0066cc; height: 20px; width: 20px; border-width: 0px; border-color: blue; border-style: solid; text-align: right;"></div>
                    ...
                    <tr>
                        <td>
                            <div id="2" style="background-color: #ff7575; height: 20px; width: 40px; border-width: 0px; border-color: blue; border-style: solid; text-align: right;"></div>
                    ...
                    <tr>
                        <td>
                            <div id="3" style="background-color: #5cadad; height: 20px; width: 30px; border-width: 0px; border-color: blue; border-style: solid; text-align: right;"></div>
