<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="meeting_initiate.aspx.cs" Inherits="Project.meeting_initiate" %>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="calendar.html"><i class="icon-calendar"></i><span class="hidden-tablet"> 我的安排</span></a></li>
					</ul>
				</div>
			</div>
			<!-- end: Main Menu -->
